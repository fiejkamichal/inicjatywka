    ...
    override fun insertCard(card: Card): Long {
        return queries.transactionWithResult {
            queries.insertCard(
                ...
                maxHitPoints = card.getStat(Card.Stat.Id.MaxHitPoints).value.toLong(),
                resilience = card.getStat(Card.Stat.Id.Resilience).value.toLong(),
                maxResilience = card.getStat(Card.Stat.Id.MaxResilience).value.toLong(),
                mana = card.getStat(Card.Stat.Id.Mana).value.toLong(),
                maxMana = card.getStat(Card.Stat.Id.MaxMana).value.toLong(),
                concentration = card.getStat(Card.Stat.Id.Concentration).value.toLong(),
                maxConcentration = card.getStat(Card.Stat.Id.MaxConcentration).value.toLong(),
